            ...
            <Card>
              ...
              <CardContent>
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  ...
                  <li>Watch the ambulance (blue) move along the path</li>
                  <li>Observe how other vehicles (green) react to the ambulance</li>
                  <li>Vehicles within 10 km ahead of the ambulance will turn red</li>
                  <li>Vehicles will return to green once the ambulance has passed</li>
                </ol>
              </CardContent>
            </Card>
          </div>
